...
namespace Mediapipe
{
  //initializes mediapipe assets and such as well as the webcam source
  public class Initializer : MonoBehaviour
  {
    ...
    private const string _TAG = nameof(Initializer);
    ...
    private IEnumerator Start()
    {
      ...
      DontDestroyOnLoad(GameObject.Find("WebcamSource"));
